...
router.get("/roles", authMiddleware, requireRole("Owner", "Direksi", "Chief Dealing", "SPV Dealing", "Corporate", "Co-SPV Dealing", "Dealer", "Admin System"), async (_req, res) => {
  try {
...
router.get("/pts", authMiddleware, requireRole("Owner", "Direksi", "Chief Dealing", "SPV Dealing", "Corporate", "Co-SPV Dealing", "Dealer", "Admin System"), async (_req, res) => {
  try {
...
router.get("/pts/:id", authMiddleware, requireRole("Owner", "Direksi", "Chief Dealing", "SPV Dealing", "Corporate", "Co-SPV Dealing", "Dealer", "Admin System"), async (req, res) => {
  try {
...
router.get("/branches", authMiddleware, requireRole("Owner", "Direksi", "Chief Dealing", "SPV Dealing", "Corporate", "Co-SPV Dealing", "Dealer", "Admin System"), async (req, res) => {
  try {
...
router.get("/branches/:id", authMiddleware, requireRole("Owner", "Direksi", "Chief Dealing", "SPV Dealing", "Corporate", "Co-SPV Dealing", "Dealer", "Admin System"), async (req, res) => {
  try {
...
router.get("/shifts", authMiddleware, requireRole("Owner", "Direksi", "Chief Dealing", "SPV Dealing", "Corporate", "Co-SPV Dealing", "Dealer", "Admin System"), async (_req, res) => {
  try {
...
router.get("/shifts/:id", authMiddleware, requireRole("Owner", "Direksi", "Chief Dealing", "SPV Dealing", "Corporate", "Co-SPV Dealing", "Dealer", "Admin System"), async (req, res) => {
  try {
...
const ALL_ROLES_MASTER = ["Owner", "Direksi", "Chief Dealing", "SPV Dealing", "Corporate", "Co-SPV Dealing", "Dealer", "Admin System", "Superadmin"];

router.get("/activity-types", authMiddleware, requireRole("Owner", "Direksi", "Chief Dealing", "SPV Dealing", "Corporate", "Co-SPV Dealing", "Dealer", "Admin System"), async (_req, res) => {
  try {
...
router.get("/activity-types/:id", authMiddleware, requireRole("Owner", "Direksi", "Chief Dealing", "SPV Dealing", "Corporate", "Co-SPV Dealing", "Dealer", "Admin System"), async (req, res) => {
  try {
