...
function Router() {
  return (
    <Switch>
      ...
      <Route path="/users"><ProtectedRoute component={() => <div><h1 className="text-3xl font-bold">User Management</h1><p className="mt-2 text-muted-foreground">Module active.</p></div>} /></Route>
