...
const ROLE_CONFIG: Record<string, { color: string; icon: React.ReactNode }> = {
  ...
  "Corporate":       { color: "text-orange-400",  icon: <Users className="w-4 h-4" /> },
...
const ROLE_ORDER: Record<string, number> = {
  ...
  "SPV Dealing": 4, "Corporate": 4.25, "Co-SPV Dealing": 4.5, "Dealer": 5, "Admin System": 6,
};
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative">
                ...
                <button
                  ...
                  className="absolute right-3 top-3 text-muted-foreground hover:text-foreground transition-colors disabled:opacity-40 disabled:cursor-not-allowed"
                  tabIndex={-1}
                  disabled={!selected}
