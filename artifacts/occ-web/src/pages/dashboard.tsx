...
function SupervisorDashboard() {
  ...
  return (
    <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
      <div>
        <h1 className="text-xl md:text-3xl font-bold tracking-tight">Dashboard Operasional</h1>
  ...
  return (
    <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
      <div className="flex flex-wrap items-start justify-between gap-3">
        <div>
          <h1 className="text-xl md:text-3xl font-bold tracking-tight">Radar Dashboard</h1>
          <p className="text-muted-foreground mt-1">Overview manajemen — semua PT.</p>
        </div>
        <div className="flex items-center gap-2 px-3 py-1.5 rounded-xl border bg-card shadow-sm shrink-0">
          <div className={`w-2.5 h-2.5 rounded-full ${pulse.color} animate-pulse`} />
          <span className={`text-xs md:text-sm font-bold ${pulse.textColor}`}>Pulse: {pulse.label}</span>
        </div>
      </div>
