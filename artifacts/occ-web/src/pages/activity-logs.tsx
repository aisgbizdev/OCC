...
import { Plus, Filter, Flag } from "lucide-react";
        ...
        <div className="overflow-x-auto">
          <table className="w-full text-sm text-left">
            ...
            <tbody className="divide-y divide-border">
              {filtered.map((log: ActivityLogWithRelations & { flagged?: boolean }) => (
              ...
              {filtered.length === 0 && (
                <tr><td colSpan={isSPV ? 7 : 6} className="text-center py-8 text-muted-foreground">Tidak ada aktivitas ditemukan</td></tr>
              )}
            </tbody>
          </table>
        </div>
